...
from fbot_rl.agents.robots import Boris
...
class OpenCabinetDrawerEnv(BaseEnv):
    ...
    **Goal Specification:**
    ...
    SUPPORTED_ROBOTS = ["fetch", "boris"]
    agent: Union[Fetch, Boris]
...
@register_env("FbotOpenCabinetDoor-v1", max_episode_steps=100)
